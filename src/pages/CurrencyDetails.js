...
export default function CurrencyDetails() {
  ...
  return (
    Currency && (
      <>
        <Box className="cryptoMobile" style={{ marginLeft: 250 }}>
          <Mobilemenu />
          <Container>
            <Box>
              <Typography
                  ...
                  <List>
                    <ListItem>
                      ...
                      <ListItemText
                        ...
                        sx={{ paddingLeft: "7px", fontWeight: "200" }}
                      />
                      <Typography
                        sx={{
                          marginLeft: "35px",
                      ...
                      >
                        $
                        {Math.sign(Currency.data.coin.price) *
                          (Math.abs(Currency.data.coin.price) / 1000).toFixed(
                            1
                          ) +
                          "k"}
                      </Typography>
                    ...
                    <ListItem>
                      ...
                      <ListItemText primary="Rank" sx={{ fontWeight: "200" }} />
                      <Typography
                        sx={{ marginLeft: "35px", fontWeight: "700" }}
                      >
                    ...
                    <ListItem>
                      ...
                      >
                        $
                        {Number(Currency.data.coin.allTimeHigh.price).toFixed(
                          1
                        )}
                      </Typography>
                    </ListItem>
